...
export function OrdersView({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* BANNER EM TOTAL DESTAQUE DE GERAR LINK DE COBRANÇA AVULSA */}
      <Card className="border-primary/30 bg-gradient-to-r from-primary/10 via-primary/5 to-background shadow-md">
        <CardContent className="p-4 sm:p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="space-y-1 max-w-2xl">
            <div className="flex items-center gap-2 text-primary font-extrabold text-base">
              ...
              <span>Cobrança Avulsa / Link de Pagamento</span>
          ...
          <Button
            ...
            size="lg"
            className="w-full md:w-auto font-black shadow-lg bg-primary hover:bg-primary/90 text-primary-foreground shrink-0 flex items-center justify-center gap-2 h-11 px-6 text-sm"
          >
            <LinkIcon className="w-5 h-5" />
